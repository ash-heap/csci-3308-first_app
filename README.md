...
[files/vendor/rails/activerecord/README.html](files/vendor/rails/activerecord/README.html).
...
[files/vendor/rails/actionpack/README.html](files/vendor/rails/actionpack/README.html).
...
3. Go to [http://localhost:3000/](http://localhost:3000/) and you'll see:
...
Mongrel or WEBrick server with ``--debugger``. This means that you can break out
of execution at any point in the code, investigate and change the model, and
then, resume execution! You need to install ruby-debug to run the server in
debugging mode. With gems, use ``sudo gem install ruby-debug``. Example:
